//
//  mapboxSoundAudioUnit.m
//  mapboxSound
//
//  Created by Chavez Bobb on 7/15/22.
//

#import "mapboxSoundAudioUnit.h"
...
@interface mapboxSoundAudioUnit ()
...
@implementation mapboxSoundAudioUnit
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription options:(AudioComponentInstantiationOptions)options error:(NSError **)outError {
	...
	_kernelAdapter = [[mapboxSoundDSPKernelAdapter alloc] init];
...
- (void)setupParameterCallbacks {
	...
	__block mapboxSoundDSPKernelAdapter * kernelAdapter = _kernelAdapter;
